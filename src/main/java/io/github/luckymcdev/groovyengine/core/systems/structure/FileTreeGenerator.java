...
public class FileTreeGenerator {
     ...
     * <p>
     * The file structure generated by this method includes the following directories and files:
     * <ul>
     *     <li>{@code MOD_ROOT}: The root directory for GroovyEngine.</li>
     *     <li>{@code SRC_DIR}: The directory containing source code.</li>
     *     <li>{@code RESOURCES_DIR}: The directory containing resource files.</li>
     *     <li>{@code SCRIPTS_DIR}: The directory containing script files.</li>
     *     <li>{@code COMMON_SCRIPTS_DIR}: The directory containing common script files.</li>
     *     <li>{@code CLIENT_SCRIPTS_DIR}: The directory containing client-side script files.</li>
     *     <li>{@code SERVER_SCRIPTS_DIR}: The directory containing server-side script files.</li>
     *     <li>{@code MODULES_DIR}: The directory containing module files.</li>
     * </ul>
     */
    ...
    /**
     * Creates a Gradle file at the specified path with the given content.
     *
     * <p>
     * This method will log a message to the console if the file is successfully created or if an error occurs.
     * </p>
     *
     * @param filePath The path to the Gradle file to create.
    ...
    /**
     * Creates a sample script file at the specified path with the given content.
     *
     * <p>
     * This method will log a message to the console if the file is successfully created or if an error occurs.
     * </p>
     *
     * @param directory The directory to create the sample script in.
     * @param filename The name of the sample script to create.
     * @param content The content of the sample script.
     */
